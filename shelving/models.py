...
class Shelving(models.Model):
    height = models.IntegerField(verbose_name="Висота стелажа (Одной полки)", null=True, blank=True)
    ...
    countShelf = models.IntegerField(verbose_name="кількість полок", null=True, blank=True)
