...
def show_index(request):
    ...
    skladSyx = WarehouseSpace.objects.filter(typeProduct="Сухі товари")
    skladSkr = WarehouseSpace.objects.filter(typeProduct="Швидко псуються товари")
    skladXry = WarehouseSpace.objects.filter(typeProduct="Крихкі товари")
